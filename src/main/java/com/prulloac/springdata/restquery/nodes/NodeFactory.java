...
import com.prulloac.springdata.restquery.nodes.comparison.EqualsIgnoreCaseNode;
import com.prulloac.springdata.restquery.nodes.comparison.EqualsNode;
import com.prulloac.springdata.restquery.nodes.comparison.GreaterThanEqualsNode;
import com.prulloac.springdata.restquery.nodes.comparison.LessThanEqualsNode;
import com.prulloac.springdata.restquery.nodes.comparison.NotNullNode;
import com.prulloac.springdata.restquery.nodes.comparison.NullNode;
...
import com.prulloac.springdata.restquery.nodes.comparison.AfterNode;
import com.prulloac.springdata.restquery.nodes.comparison.BeforeNode;
import com.prulloac.springdata.restquery.nodes.comparison.BetweenNode;
import com.prulloac.springdata.restquery.nodes.comparison.ContainsIgnoreCaseNode;
import com.prulloac.springdata.restquery.nodes.comparison.ContainsNode;
import com.prulloac.springdata.restquery.nodes.comparison.DateTimeComparisonNode;
import com.prulloac.springdata.restquery.nodes.comparison.EndsWithIgnoreCaseNode;
import com.prulloac.springdata.restquery.nodes.comparison.EndsWithNode;
import com.prulloac.springdata.restquery.nodes.comparison.GreaterThanNode;
import com.prulloac.springdata.restquery.nodes.comparison.InNode;
import com.prulloac.springdata.restquery.nodes.comparison.LessThanNode;
import com.prulloac.springdata.restquery.nodes.comparison.StartsWithIgnoreCaseNode;
import com.prulloac.springdata.restquery.nodes.comparison.StartsWithNode;
import com.prulloac.springdata.restquery.operators.QueryOperator;

import java.util.Arrays;
import java.util.List;
import java.util.stream.Collectors;

import static com.prulloac.springdata.restquery.operators.ComparisonOperator.AFTER;
import static com.prulloac.springdata.restquery.operators.ComparisonOperator.BEFORE;
import static com.prulloac.springdata.restquery.operators.ComparisonOperator.BETWEEN;
import static com.prulloac.springdata.restquery.operators.ComparisonOperator.CONTAINS;
import static com.prulloac.springdata.restquery.operators.ComparisonOperator.CONTAINS_IGNORE_CASE;
import static com.prulloac.springdata.restquery.operators.ComparisonOperator.DISTINCT;
import static com.prulloac.springdata.restquery.operators.ComparisonOperator.ENDS_WITH;
import static com.prulloac.springdata.restquery.operators.ComparisonOperator.ENDS_WITH_IGNORE_CASE;
import static com.prulloac.springdata.restquery.operators.ComparisonOperator.EQUALS;
import static com.prulloac.springdata.restquery.operators.ComparisonOperator.EQUALS_IGNORE_CASE;
import static com.prulloac.springdata.restquery.operators.ComparisonOperator.GREATER_THAN;
import static com.prulloac.springdata.restquery.operators.ComparisonOperator.GREATER_THAN_EQUALS;
import static com.prulloac.springdata.restquery.operators.ComparisonOperator.IN;
import static com.prulloac.springdata.restquery.operators.ComparisonOperator.LESS_THAN;
import static com.prulloac.springdata.restquery.operators.ComparisonOperator.LESS_THAN_EQUALS;
import static com.prulloac.springdata.restquery.operators.ComparisonOperator.NOT_NULL;
import static com.prulloac.springdata.restquery.operators.ComparisonOperator.NULL;
import static com.prulloac.springdata.restquery.operators.ComparisonOperator.STARTS_WITH;
import static com.prulloac.springdata.restquery.operators.ComparisonOperator.STARTS_WITH_IGNORE_CASE;
import static com.prulloac.springdata.restquery.operators.LogicalOperator.AND;
import static com.prulloac.springdata.restquery.operators.LogicalOperator.NOT;
import static com.prulloac.springdata.restquery.operators.LogicalOperator.OR;
