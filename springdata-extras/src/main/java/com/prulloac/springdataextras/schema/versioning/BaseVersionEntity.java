...
import com.prulloac.springdataextras.schema.versioning.strategy.VersionStrategy;
...
public abstract class BaseVersionEntity<T extends Serializable>
  ...
  public final <T extends VersionStrategy>  void setVersionStrategyImplementation(Class<T> implementation) {
