...
public enum QueryOperation {
	...
	/**
	 * Represents a JPQL 'not in' predicate consisting in applying a not predicate that negates the result of
	 * the predicate generated with {@link javax.persistence.criteria.CriteriaBuilder#in(Expression)}
	...
	/**
	 * Represents a JPQL 'like' predicate with a wildcard as suffix and prefix and uppercase applied to both sides of the comparison
	 * @see javax.persistence.criteria.CriteriaBuilder#like(Expression, String)
	 */
	...
	/**
	 * Represents a JPQL 'or' predicate that combines with a logic OR both the predicates of a 'like' with a wildcard
	 * as suffix and prefix, and a 'is null' predicate
	...
	/**
	 * Represents a JPQL 'or' predicate that combines with a logic OR both the predicates of a 'like' with a wildcard
	 * as suffix and prefix and uppercase applied to both sides of the operation, and a 'is null' predicate
	 * @see javax.persistence.criteria.CriteriaBuilder#or(Predicate...)
	 */
	...
	/**
	 * Represents a JPQL 'like' predicate with a wildcard as suffix and uppercase applied to both sides of the comparison
	 * @see javax.persistence.criteria.CriteriaBuilder#like(Expression, String)
	 */
	...
	/**
	 * Represents a JPQL 'like' predicate with a wildcard as prefix and uppercase applied to both sides of the comparison
	 * @see javax.persistence.criteria.CriteriaBuilder#like(Expression, String)
	 */
